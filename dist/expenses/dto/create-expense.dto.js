...
__decorate([
    (0, swagger_1.ApiProperty)({
        example: 'Канцелярия',
        description: 'Категория расхода (бумага, вода, доставка, аренда и т.д.). Свободный текст, чтобы админ сам решал, как структурировать.',
    }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        example: '2026-04-26',
        description: 'Дата фактического расхода. Если не указана — берётся текущая.',
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], CreateExpenseDto.prototype, "spentAt", void 0);
